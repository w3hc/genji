...
export const translations: Translations = {
  ...
  fr: {
    ...
    wallet: {
      ...
      description:
        'Signez et vérifiez en toute sécurité des messages Ethereum avec votre portefeuille',
      noWalletFound: 'Aucun Portefeuille Ethereum Trouvé',
      createWallet: 'Créer un Nouveau Portefeuille Ethereum',
      regenerateWallet: 'Générer un Nouveau Portefeuille',
      flushDb: 'Vider la BD',
      yourAddress: 'Votre Adresse de Portefeuille Ethereum',
      ...
      verificationSuccess:
        "La signature est valide et correspond à l'adresse du portefeuille actuel",
      verificationFailed: "La signature ne correspond pas à l'adresse du portefeuille actuel",
    },
    navigation: {
